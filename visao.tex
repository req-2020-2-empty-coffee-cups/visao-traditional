...
\begin{itemize}
    ...
    \item Criar, apagar, editar e visualizar tarefas;
...
\section{Atores}
\IBGEtabfontsize
\begin{longtable}{@{}llp{0.4\textwidth}l@{}}
...
% \label{tab:ucxx:regras_de_negocio} \\
% \toprule
% \textbf{Id.} & \textbf{Nome} & \textbf{Descrição} \\ \midrule
% RN01 & Nome & Descrição \phantomsection \label{ucxx:rn01_nome} \\ \midrule
% RN02 & Nome & Descrição \phantomsection \label{ucxx:rn02_nome} \\ \bottomrule
% \end{longtable}
...
% \begin{enumerate}[label=\textbf{FA{\arabic*}},font=\normalsize]
%     \item \textbf{\normalsize Nome do fluxo 1} \label{ucxx:fluxo_alternativo:nome_fluxo_1}
%     \begin{enumerate}[label={\arabic*}.]
%         \item Passo 1 do fluxo \label{ucxx:fluxo_alternativo:nome_fluxo_1:nome_passo1}
%         \item Passo N do fluxo
%     \end{enumerate}

%     \item \textbf{\normalsize Nome do fluxo 2}
%     \begin{enumerate}[label={\arabic*}.]
%         \item Passo 1 do fluxo
%         \item Passo N do fluxo
%     \end{enumerate}
% \end{enumerate}

% \section{Fluxos Excepcionais}
% \begin{enumerate}[label=\textbf{FE{\arabic*}},font=\normalsize]
%     \item \textbf{\normalsize Nome do fluxo 1} \label{ucxx:fluxo_excepcional:nome_fluxo_1}
%     \begin{enumerate}[label={\arabic*}.]
%         \item Passo 1 do fluxo \label{ucxx:fluxo_excepcional:nome_fluxo_1:nome_passo1}
%         \item Passo N do fluxo
%     \end{enumerate}
...
\toprule
\textbf{Id.} & \textbf{Nome} & \textbf{Descrição} \\ \midrule
\label{uc01:rn01_validacao_anotacao} UC01-RN01 \phantomsection  & Validação de anotação & A anotação será considerada válida se houver conteúdo nos campos de título ou conteúdo. Isto é, anotações com um dos dois campos nulo ou vazio são válidas, e anotações com ambos os campos vazios são inválidas \\ \midrule
\label{uc01:rn02_flag_arquivar} UC01-RN02\phantomsection  & Anotações arquivadas & Uma anotação é considerada arquivada se o conteúdo no campo numérico de arquivamento for configurado diferente de zero \\ \bottomrule
\end{longtable}
...
%
% Caso de uso UC02 - Gerenciar etiquetas
%
...
\toprule
\textbf{Id.} & \textbf{Nome} & \textbf{Descrição} \\ \midrule
\label{uc02:rn01_validar} UC02-RN01\phantomsection & Validar etiqueta & A etiqueta será considerada válida se houver conteúdo no campo nome. Isto é, etiqueta campo nome nulo ou vazio não  são permitidas \\ \bottomrule
...
\toprule
\textbf{Id.} & \textbf{Nome} & \textbf{Descrição} \\ \midrule
UC03-RN01 & Validar tarefa & A Tarefa será considerada válida se o campo de conteúdo não estiver vazio ou nulo.  \phantomsection \label{uc03:rn01_validar_tarefa} \\ \midrule
UC03-RN02 & Validar lista de tarefa & A lista de tarefa é considerada válida se e somente se o seu campo de título não for nulo ou vazio \phantomsection \label{uc03:rn02_validar_lista_tarefa} \\ \bottomrule
\end{longtable}
